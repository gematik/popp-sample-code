...
final class PoppTokenHeader {
  ...
  PoppTokenHeader(JwkKidGenerator jwkKidGenerator) {
    this.jwkKidGenerator = jwkKidGenerator;
  }

  Map<String, Object> createPoppHeader(final ECPublicKey publicKey, final String sessionId) {
    try {
      return createHeadersForPoppToken(publicKey);
