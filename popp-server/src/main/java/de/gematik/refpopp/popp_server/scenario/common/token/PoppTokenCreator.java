...
public class PoppTokenCreator {
  ...
  private final PoppTokenClaims tokenClaims;
  private final PoppTokenHeader tokenHeader;
  private final JwtTokenBuilder jwtTokenBuilder;

  PoppTokenCreator(
      final CertificateProviderService certificateProviderService,
      final PoppTokenClaims tokenClaims,
      final PoppTokenHeader tokenHeader,
  ...
  public String createPoppToken(final X509Data x509Data, final String sessionId) {
    ...
    final var headers = tokenHeader.createPoppHeader(publicKey, sessionId);
