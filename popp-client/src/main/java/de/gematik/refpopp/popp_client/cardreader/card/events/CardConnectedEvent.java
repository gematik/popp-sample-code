...
public class CardConnectedEvent extends CardEvent {

  @Getter private final String eventMessage;
  private final CardChannel cardChannel;

  public CardConnectedEvent(final CardChannel cardChannel, final String message) {
    super(cardChannel);
